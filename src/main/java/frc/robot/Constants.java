...
public final class Constants {
  ...
  public static final int INTAKE_SWING_ENCODER_DIO_PIN_A      =4;
  public static final int INTAKE_SWING_ENCODER_DIO_PIN_B      =5;

  public static final int INTAKE_SWING_LIMIT_SWITCH_DIO_PIN   =6;
